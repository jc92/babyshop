...
const STANDARD_AI_CATEGORIES = [
  {
    ...
    label: "Sleep Support",
    description:
      "Sleep surfaces, bedtime routines, and soothing gear to maintain safe sleep habits.",
    bestPractices:
  ...
  },
  {
    ...
    label: "Feeding Tools",
    description:
      "Breastfeeding, bottle, and solids gear that supports hydration and nutrition milestones.",
    bestPractices:
  ...
  },
  {
    ...
    description:
      "Transportation, baby-wearing, and proofing essentials aligned to motor development windows.",
    bestPractices:
  ...
  },
  {
    ...
    description:
      "Play gyms, toys, and sensory tools that match cognitive and motor development stages.",
    bestPractices:
  ...
  },
  {
    ...
    description:
      "Monitoring tech, health kits, and air-quality tools supporting proactive wellness.",
    bestPractices:
...
export async function seedMilestonesFromDefaults() {
