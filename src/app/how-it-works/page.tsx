...
export const metadata: Metadata = {
  ...
  description:
    "See Nestlings Planner’s step-by-step approach to translating your family profile into milestone-ready checklists, curated gear, and advisor support.",
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_SITE_URL ?? "https://nestlings.app"}/how-it-works`,
  },
  openGraph: {
    title: "How Nestlings Planner Works",
    description:
      "Discover how Nestlings turns a two-minute profile into AI-guided milestone plans and trusted product picks for new parents.",
    url: `${process.env.NEXT_PUBLIC_SITE_URL ?? "https://nestlings.app"}/how-it-works`,
  },
};
...
const milestones = [
  {
    ...
    description:
      "Share your due date, home helpers, budget comfort, and the vibe you’re hoping for. It takes two minutes and stays tucked inside your Nestlings Planner profile only.",
  },
  {
    title: "2. Build your milestone roadmap 🗺️",
    description:
      "We turn those answers into a month-by-month roadmap. The AI advisor flags what to prep, book, or learn next—timed with pediatric guidance so reminders land right on cue.",
  },
  {
    title: "3. Gather parent-loved picks 🛍️",
    description:
      "We review trusted shops and real caregiver feedback to surface gear that fits your budget, space, and style. The advisor layers in safety notes, eco highlights, and price checks that stay current for you.",
  },
  {
    title: "4. Personalize with smart sorting 🎯",
    description:
      "Nestlings Planner and the AI advisor gently bump the matches to the top—think hypoallergenic fabrics, compact strollers, or under-$200 must-haves—while filtering out anything that doesn’t fit.",
  },
  {
    title: "5. Share the why behind every pick 💡",
    description:
      "Each card breaks down why it’s recommended, the age window it supports, and the quick pros to consider. Pin favorites, swap in alternatives, or ask the advisor a follow-up to save ideas with one click.",
  },
  {
    title: "6. Stay supported the whole way 🤝",
    description:
      "Prefer a human gut check? Our curators review new additions, the advisor keeps an eye on what’s next, and you can message the Nestlings team, export checklists, or pause suggestions anytime—your pace wins.",
  },
];
...
export default function HowItWorksPage() {
  return (
    <div className="min-h-screen bg-[var(--baby-neutral-50)] text-[var(--dreambaby-text)]">
      ...
      <main className="mx-auto w-full max-w-6xl px-6 pt-28 pb-20 space-y-16">
        <header className="rounded-3xl border border-[var(--baby-neutral-200)] bg-white/90 p-10 shadow-[0_24px_60px_rgba(111,144,153,0.12)] backdrop-blur">
          ...
          <p className="mt-4 max-w-3xl text-lg text-[var(--dreambaby-muted)]">
            Nestlings Planner pairs our AI advisor with real-parent insight so you always know what to do next. Take a look at how we go from your first answers to a calm, trustworthy plan.
          </p>
        ...
        <section className="rounded-3xl border border-[var(--baby-neutral-200)] bg-white/95 p-8 shadow-sm">
          <div className="grid gap-8 lg:grid-cols-[minmax(0,0.6fr)_minmax(0,1fr)] lg:items-start">
            <div>
              ...
              <p className="mt-2 text-sm text-[var(--dreambaby-muted)]">
                We designed Nestlings Planner for busy caregivers who need clarity and confidence—not surprises. These commitments keep the AI advisor helpful, your plan reliable, and your data safe.
              </p>
            </div>
        ...
        <section className="rounded-3xl bg-gradient-to-br from-[var(--baby-primary-500)] to-[var(--baby-secondary-400)] px-8 py-10 text-white shadow-[0_24px_50px_rgba(111,144,153,0.25)]">
