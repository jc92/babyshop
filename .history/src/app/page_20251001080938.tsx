...
type ActiveView = "plan" | "profile" | "timeline" | "curated";
...
export default function Home() {
  ...
  const sidebarViews: {
  ...
  }[] = [
    {
      id: "plan",
      label: "Plan settings",
      description: "Budget, due date, sustainability",
    },
    {
      id: "profile",
      label: "Baby profile",
      description: "Care network, medical notes",
    },
    {
      id: "timeline",
      label: "Timeline roadmap",
      description: "Milestones and agent insights",
    },
    {
      id: "curated",
      label: "Curated picks",
      description: "Ranked products by preferences",
    },
  ];
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-8 px-6 py-10 lg:flex-row">
        <aside className="lg:w-72">
          <nav className="rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-sm backdrop-blur lg:sticky lg:top-32">
        ...
        <div className="flex-1 space-y-8">
          {activeView === "plan" && (
            <section className="space-y-6 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="space-y-2">
                <h2 className="text-xl font-semibold text-slate-900">Plan inputs</h2>
                <p className="text-sm text-slate-600">
