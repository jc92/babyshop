...
export default function Home() {
  ...
  const mapCategory = (backendCategory: string): CategoryId => {
    ...
    return categoryMap[backendCategory] || 'nursing';
  };
  ...
  const fetchProducts = async () => {
    try {
      ...
      const transformedProducts: ProductSummary[] = data.products.map((product: {
        id: string;
        name: string;
        description?: string;
        category: string;
        ...
        category: product.category as any, // Type assertion for now
        milestoneIds: product.milestone_ids || [],
        affiliateUrl: product.affiliate_url || '',
        colors: [], // Not in backend yet
        materials: [], // Not in backend yet
        isEcoFriendly: product.eco_friendly || false,
        rating: product.rating || 0,
        reviewSummary: product.description || 'No description available',
        checklistNotes: '', // Not in backend yet
      }));
