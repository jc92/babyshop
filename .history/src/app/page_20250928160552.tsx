          ...
          <div className="overflow-x-auto">
            <div className="min-w-[760px] space-y-6">
              ...
              {timelineMilestones.map((milestone) => {
                ...
                const maxAllowedWidth = Math.max(100 - offsetPercentage, 8);
                const normalizedWidth = Math.min(
                  Math.max(baseWidth, 8),
                  maxAllowedWidth,
                );
                ...
                return (
                  <div
                    key={milestone.id}
                    className="grid items-center gap-4 rounded-xl border border-slate-200/70 bg-slate-50/80 p-4 shadow-inner md:grid-cols-[220px_1fr]"
                  >
                    ...
                    <div className="relative h-16 overflow-hidden rounded-xl border border-indigo-100/60 bg-white shadow-lg/20">
                      <div
                      ...
                      <div className="relative flex h-full items-center">
                        ...
                        >
                          <div className="flex h-12 w-full items-center justify-between gap-3 rounded-full bg-indigo-500/85 px-4 text-xs font-medium text-indigo-50 shadow-lg">
                            <span className="text-[10px] uppercase tracking-wide text-indigo-200">
                              {milestone.monthRange[0]}–{milestone.monthRange[1]} mo window
                            </span>
                            <span className="text-xs font-semibold text-indigo-50">
                              Key arrivals
                            </span>
                          </div>
                        </div>
