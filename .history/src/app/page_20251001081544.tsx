  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-8 px-6 py-10 lg:flex-row">
        <aside
          className={`fixed inset-y-0 left-0 z-40 w-72 transform bg-white/95 shadow-xl transition-transform duration-300 ease-in-out lg:static lg:inset-auto lg:block lg:w-72 lg:transform-none lg:shadow-none ${
            isSidebarOpen ? "translate-x-0" : "-translate-x-full"
          } lg:translate-x-0`}
        >
          <nav className="flex h-full flex-col gap-6 border-slate-200 bg-white/90 px-5 py-6 backdrop-blur lg:rounded-2xl lg:border lg:shadow-sm lg:px-4 lg:py-5">
