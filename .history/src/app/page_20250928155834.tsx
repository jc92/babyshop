...
export default function Home() {
  ...
  const totalTimelineMonths = maxTimelineMonth - minTimelineMonth;
        ...
        <section className="grid gap-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-lg/20">
          ...
          <div className="overflow-x-auto">
            <div className="min-w-[680px] space-y-4">
              ...
              <div
                className="space-y-4 rounded-xl border border-slate-200 bg-slate-100/70 p-4"
                style={{
                  backgroundImage:
                    axisMarks.length > 1
                  ...
                  return (
                    <div key={milestone.id} className="space-y-2">
                      ...
                      <div className="relative h-16">
                        <div
                          className="absolute top-1/2 flex h-14 -translate-y-1/2 items-center rounded-xl border border-indigo-200 bg-gradient-to-r from-indigo-100 via-indigo-100/80 to-indigo-200/60 shadow-sm"
                          style={{
                            width: `${widthPercentage}%`,
                            left: `${offsetPercentage}%`,
                          }}
                        >
                          <div className="flex flex-col gap-1 px-4 text-xs text-indigo-900">
                            <p className="font-semibold">{milestone.description}</p>
                            <p className="text-[11px] text-indigo-700/80">
                              Key arrivals align with this window.
                            </p>
                          </div>
                        </div>
                      </div>
