...
export default function Home() {
  ...
  const sidebarViews: {
    ...
    {
      id: "timeline",
      label: "Calendar & curation",
      description: "Calendar view, insights, curated picks",
    },
  ];

  return (
    <div className="min-h-screen parent-gradient text-slate-800">
      <header className="border-b border-amber-200/30 bg-white/80 backdrop-blur parent-soft-shadow">
        <div className="mx-auto max-w-6xl px-6 py-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
              <h1 className="text-3xl font-semibold text-amber-900">Nestlings Monthly</h1>
            <p className="text-sm text-amber-700">
              Intelligent baby essentials subscription planner for new parents.
            </p>
          </div>
            <div className="flex flex-col items-end gap-2">
          <div className="parent-card rounded-lg px-4 py-3 text-sm text-amber-800">
            <p className="font-medium">Current plan: {profile.budget}</p>
            <p className="text-xs text-amber-600">{budgetCopy[profile.budget]}</p>
          </div>
      ...
      <main className="mx-auto max-w-6xl space-y-10 px-6 py-10">
        ...
        {activeSection === "baby" && (
          <section className="parent-card rounded-3xl p-6 shadow-xl">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div className="space-y-1">
                ...
                <h2 className="text-2xl font-semibold text-amber-900">Capture the little details</h2>
                <p className="text-sm text-amber-700">
              ...
              <div className="hidden sm:block">
                <div className="relative">
                  <div className="absolute inset-0 rounded-full bg-amber-200 blur-3xl opacity-30" />
                  <div className="relative rounded-full border border-amber-100 bg-white px-4 py-2 text-xs font-medium text-amber-600">
