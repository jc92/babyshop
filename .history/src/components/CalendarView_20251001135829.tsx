            ...
            {months.map((month) => {
              ...
              return (
                <div
                  ...
                  className={`flex-shrink-0 w-80 px-4 py-3 text-center font-semibold border-r border-slate-200 ${
                    isCurrentMonth ? 'bg-indigo-50 text-indigo-900' : 'bg-slate-50 text-slate-700'
                  }`}
                >
