      ...
      >
        <div className="relative min-w-max">
          ...
          <div className="relative bg-slate-50/30 min-h-[200px] pt-4">
            ...
            <div className="absolute top-4 left-0 right-0 h-1 bg-blue-500/20 z-5"></div>
              ...
              return (
                <div
                  ...
                  className={`absolute h-14 rounded-xl cursor-pointer transition-all duration-200 flex items-center px-4 group ${
                    isActive
                      ? 'bg-blue-100 border-2 border-blue-400 text-blue-900 shadow-lg transform scale-105'
                      : isPast
