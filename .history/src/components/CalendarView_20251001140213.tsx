    ...
    <div className="rounded-3xl border border-slate-200/70 bg-white shadow-xl overflow-hidden">
      ...
      >
        <div className="relative min-w-max">
          ...
          <div className="relative bg-slate-50/30 min-h-[200px]">
            {/* Timeline track background */}
            <div className="absolute inset-0 bg-gradient-to-r from-slate-50 to-indigo-50/30"></div>
            
            {/* Top timeline row indicator */}
            <div className="absolute top-0 left-0 right-0 h-1 bg-indigo-500/20 z-5"></div>
            ...
            {milestones.map((milestone, index) => {
              ...
              const top = 10 + (index * 60); // Stack milestones vertically, starting closer to top
