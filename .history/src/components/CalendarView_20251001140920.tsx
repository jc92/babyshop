    ...
    <div className="dreambaby-card rounded-3xl shadow-xl overflow-hidden">
      ...
      >
        <div className="relative min-w-max">
          ...
          <div className="flex sticky top-0 bg-white z-20 border-b-2 border-amber-200 shadow-lg">
            {months.map((month, index) => {
              ...
              return (
                <div
                  ...
                  className={`flex-shrink-0 w-80 px-4 py-4 text-center font-semibold border-r border-amber-200 transition-colors ${
                    isCurrentMonth 
