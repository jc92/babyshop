  ...
  useEffect(() => {
    ...
    const items = new DataSet(
      filteredMilestones.map((milestone, index) => {
        ...
        return {
          id: milestone.id,
          content: `<div style="display:flex;flex-direction:column;align-items:flex-start;gap:4px;color:white;padding:14px 18px;border-radius:9999px;background:${palette.gradient};box-shadow:0 18px 35px -18px ${palette.halo};font-family:Inter,sans-serif;font-size:12px;line-height:1.2;">
